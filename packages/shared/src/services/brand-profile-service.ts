 ...
 */
export function buildBrandProfilePrompt(briefing: Briefing): string {
 ...
 */
export function parseGeneratedProfile(response: string): GeneratedBrandProfile {
  try {
 ...
 */
export async function generateBrandProfile(briefing: Briefing): Promise<{

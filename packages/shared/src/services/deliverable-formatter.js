 ...
 */
export function formatInstagramCarousel(headline, subheadline, bodyText, cta, brandProfile) {
 ...
 */
export function formatLinkedInPosts(headline, subheadline, bodyText, cta) {
    return [
        {
            type: 'article',
 ...
 */
export function formatLandingPageDraft(headline, subheadline, bodyText, cta, brandProfile, _briefing) {
    return {
        sections: {
            hero: {
                headline,
 ...
 */
export function packageDeliverables(headline, subheadline, bodyText, cta, socialPost, brandProfile, briefing) {
    return {
        instagram_carousel: formatInstagramCarousel(headline, subheadline, bodyText, cta, brandProfile),
        linkedin_posts: formatLinkedInPosts(headline, subheadline, bodyText, cta),
        landing_page_draft: formatLandingPageDraft(headline, subheadline, bodyText, cta, brandProfile, briefing),
    };
}
//# sourceMappingURL=deliverable-formatter.js.map